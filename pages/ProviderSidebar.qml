...
Rectangle {
    ...
    property string currentProviderId: "codearts"
    implicitWidth: 56
    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: Rectangle {
                ...
                color:  sidebar.currentProviderId === providerId ? AppTheme.primarySoft : providerMouseArea.containsMouse ? AppTheme.surfaceHover : "transparent"
                border.width: sidebar.currentProviderId === providerId ? 1 : 0
                ...
                MouseArea {
                    ...
                    onClicked: {
                        sidebar.currentProviderId = providerId

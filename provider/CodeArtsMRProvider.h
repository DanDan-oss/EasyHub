...
struct RefreshContext
{
    ...
    RefreshType type = RefreshType::Sync;
...
public:
    ...
    void loadMergeRequests(quint64 requestId, MergeRequestState state) override;
...
private:
    ...
    void requestMergeRequestList(quint64 requestId, const QString& scope, const QString& state);
    void handleMergeRequestListReply(const QByteArray& body, quint64 requestId, const QString& scope);
    void startMergeRequestLoad(quint64 requestId, MergeRequestState state, RefreshType type);
    ...
    void failRefresh(quint64 requestId, RefreshType type, MergeRequestState state, const QString& error);
